...
@interface HomePagedNews() <UIScrollViewDelegate>
...
{
    if ([self.homePagedNewsDelegate respondsToSelector:@selector(homePagedNewsDidTapOnCurrentElement:)]) {
        [self.homePagedNewsDelegate homePagedNewsDidTapOnCurrentElement:self];
    }
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if ([self.homePagedNewsDelegate respondsToSelector:@selector(homePagedNews:didScrollToIndex:)]) {
        [self.homePagedNewsDelegate homePagedNews:self
